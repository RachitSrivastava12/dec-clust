...
//             {/* Right — Terminal */}
//             <div
//   className="animate-float delay-3 terminal"
//   style={{
//     position: "relative",
...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .font-display { font-family: var(--font-display); }
  @keyframes border-flow { 0%, 100% { opacity: 0.3; } 50% { opacity: 1; } }
  @keyframes pulse-dot { 0%, 100% { box-shadow: 0 0 0 0 rgba(0,255,170,0.7); opacity: 1; } 70% { box-shadow: 0 0 0 8px rgba(0,255,170,0); opacity: 0.8; } }
  @keyframes flicker { 0%, 100% { opacity: 1; } 92% { opacity: 1; } 93% { opacity: 0.6; } 94% { opacity: 1; } 96% { opacity: 0.8; } 97% { opacity: 1; } }
  @keyframes scan { 0% { transform: translateY(-100%); } 100% { transform: translateY(100vh); } }
  @keyframes float-up { from { transform: translateY(30px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
  @keyframes count-up { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
  @keyframes grid-pan { 0% { transform: translateY(0); } 100% { transform: translateY(60px); } }
  .animate-float { animation: float-up 0.8s cubic-bezier(0.16, 1, 0.3, 1) both; }
  .delay-1 { animation-delay: 0.1s; }
  .delay-2 { animation-delay: 0.2s; }
  .delay-3 { animation-delay: 0.3s; }
  ...
  .glitch-wrap::before { color: var(--red); animation: glitch-1 4s infinite linear; opacity: 0.7; }
  .glitch-wrap::after { color: var(--accent); animation: glitch-1 4s infinite linear reverse; animation-delay: 0.15s; opacity: 0.7; }
  .feature-card {
    background: var(--surface);
    border: 1px solid var(--border);
    border-radius: 12px;
  ...
  .terminal {
    ...
    border-radius: 12px;
    overflow: hidden;
    box-shadow: 0 20px 60px rgba(0,0,0,0.7), var(--accent-glow);
    min-height: 520px;
  }
  .terminal-header {
    display: flex;
          ...
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            ...
            <div className="animate-float delay-3 terminal" style={{ position: "relative" }}>
              ...
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                {/* NEW LIVE CLUSTER VISUALIZATION - FILLS THE SPACE */}
                <div style={{
                  marginTop: 8,
                  padding: 16,
                  background: "var(--bg)",
                  ...
                  <div style={{ fontSize: 10, color: "var(--muted)", letterSpacing: "0.15em", marginBottom: 12 }}>
                    LIVE CLUSTER MAP • 23 WALLETS
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                    <div style={{ textAlign: "center" }}>
                      <div style={{ width: 42, height: 42, background: "var(--accent)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 4px", color: "#000", fontWeight: 700 }}>
                        P
                      </div>
                      <div style={{ fontSize: 11, color: "var(--accent)" }}>7xKp...9mNr</div>
                      <div style={{ fontSize: 10, color: "var(--muted)" }}>847 SOL</div>
                    </div>
                    ...
                    <div style={{ display: "flex", gap: 6 }}>
                      {[1,2,3,4,5].map(i => (
                        <div key={i} style={{
                          ...
                          background: i <= 3 ? "var(--accent)" : "var(--accent-dim)",
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontSize: 10, color: "#000", fontWeight: 700,
                          border: i > 3 ? "1px solid var(--accent)" : "none"
                        }}>
                          {i}
                        </div>
                      ))}
                  ...
                  <div style={{ fontSize: 10, color: "var(--muted)", textAlign: "center", marginTop: 12 }}>
                    Detected 4.2s ago • High rug risk
                  </div>
                </div>
              </div>
            </div>
